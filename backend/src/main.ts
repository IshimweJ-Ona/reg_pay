...
async function bootstrap() {
  ...
  // Every controller now responds under /v1/... (e.g. /v1/auth/login).
  // Static assets (/uploads/) and the Swagger docs UI (/api) bypass Nest's
  // router entirely, so neither is affected by this.
