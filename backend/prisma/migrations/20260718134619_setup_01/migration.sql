...
CREATE TABLE `approval_request_actions` (
    ...
    INDEX `Approval_request_actions_action_by_fkey`(`action_by`),
...
CREATE TABLE `approval_requests` (
    ...
    INDEX `Approval_requests_initiated_by_fkey`(`initiated_by`),
...
CREATE TABLE `approval_workflow_steps` (
    ...
    INDEX `Approval_workflow_steps_department_id_fkey`(`department_id`),
    INDEX `Approval_workflow_steps_role_id_fkey`(`role_id`),
...
CREATE TABLE `audit_logs` (
    ...
    INDEX `Audit_logs_employee_id_fkey`(`employee_id`),
...
CREATE TABLE `branch_managers` (
    ...
    INDEX `Branch_managers_assigned_by_fkey`(`assigned_by`),
...
CREATE TABLE `employee_documents` (
    ...
    INDEX `Employee_documents_uploaded_by_fkey`(`uploaded_by`),
...
CREATE TABLE `ikimina_memberships` (
    ...
    INDEX `idx_ikimina_membership_location`(`working_location_id`),
    INDEX `idx_ikimina_membership_department`(`department_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `payment_batch_items` (
    ...
    INDEX `Payment_batch_items_approved_by_fkey`(`approved_by`),
    INDEX `Payment_batch_items_transaction_id_fkey`(`transaction_id`),
...
CREATE TABLE `payment_batches` (
    ...
    INDEX `Payment_batches_approved_by_fkey`(`approved_by`),
    INDEX `Payment_batches_submitted_by_fkey`(`submitted_by`),
...
CREATE TABLE `payroll_batch_approval_actions` (
    ...
    INDEX `Payroll_batch_approval_actions_action_by_fkey`(`action_by`),
...
CREATE TABLE `time_records` (
    ...
    INDEX `Time_records_approved_by_fkey`(`approved_by`),
    INDEX `idx_time_record_location`(`working_location_id`),
    INDEX `idx_time_record_department`(`department_id`),
...
CREATE TABLE `transactions` (
    ...
    INDEX `Transactions_approved_by_fkey`(`approved_by`),
    INDEX `Transactions_payment_structure_id_fkey`(`payment_structure_id`),
    INDEX `idx_transaction_date`(`payment_date`),
    INDEX `idx_transaction_employee`(`employee_id`),
    INDEX `idx_transaction_status`(`transaction_status`),
    INDEX `idx_transaction_location`(`working_location_id`),
    INDEX `idx_transaction_department`(`department_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `transfer_requests` (
    ...
    INDEX `Transfer_requests_approved_by_fkey`(`approved_by`),
    INDEX `Transfer_requests_employee_id_fkey`(`employee_id`),
    INDEX `Transfer_requests_requested_by_fkey`(`requested_by`),
    INDEX `Transfer_requests_user_id_fkey`(`user_id`),
...
CREATE TABLE `user_permission_overrides` (
    ...
    INDEX `User_permission_overrides_changed_by_fkey`(`changed_by`),
    INDEX `idx_user_permission_override_allowed`(`is_allowed`),
    INDEX `idx_user_permission_override_key`(`permission_key`),
    INDEX `idx_user_permission_override_user`(`user_id`),
    UNIQUE INDEX `User_permission_overrides_user_id_permission_key_key`(`user_id`, `permission_key`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `user_permissions` (
    ...
    INDEX `User_permissions_granted_by_fkey`(`granted_by`),
...
CREATE TABLE `working_locations` (
    ...
    INDEX `Working_locations_created_by_fkey`(`created_by`),
    INDEX `Working_locations_deleted_by_fkey`(`deleted_by`),
    INDEX `Working_locations_updated_by_fkey`(`updated_by`),
...
-- AddForeignKey
ALTER TABLE `ikimina_memberships` ADD CONSTRAINT `Ikimina_memberships_working_location_id_fkey` FOREIGN KEY (`working_location_id`) REFERENCES `working_locations`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ikimina_memberships` ADD CONSTRAINT `Ikimina_memberships_department_id_fkey` FOREIGN KEY (`department_id`) REFERENCES `departments`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `time_records` ADD CONSTRAINT `Time_records_working_location_id_fkey` FOREIGN KEY (`working_location_id`) REFERENCES `working_locations`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `time_records` ADD CONSTRAINT `Time_records_department_id_fkey` FOREIGN KEY (`department_id`) REFERENCES `departments`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `transactions` ADD CONSTRAINT `Transactions_working_location_id_fkey` FOREIGN KEY (`working_location_id`) REFERENCES `working_locations`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
