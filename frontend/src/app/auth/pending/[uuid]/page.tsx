...
export default function PendingApprovalPage() {
  ...
  if (isLoading || !user) {
    return (
      <LoadingState
        title="Loading approval status"
        description="Checking your registration and account review details."
  ...
  return (
    <div className="min-h-screen bg-muted/40 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-1 shadow-md border-t-4 border-t-accent">
          <CardHeader>
            <CardTitle className="text-lg flex items-center gap-2 text-foreground">
              <User01 className="h-5 w-5 text-muted-foreground" size={20} />
              Account profile
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex flex-col items-center py-4">
              <div className="h-20 w-20 rounded-full bg-accent/10 flex items-center justify-center mb-3">
                <User01 className="h-10 w-10 text-accent" size={40} />
              </div>
        ...
        <Card className="md:col-span-2 shadow-sm border-t-4 border-t-destructive">
          ...
          <CardContent className="pt-6 space-y-6">
            <div className="bg-card border-l-4 border-l-destructive p-6 rounded-r-lg shadow-sm">
              <p className="text-lg leading-relaxed text-foreground/80">
                An administrator needs to verify your account, assign your role, and grant the permissions you need before you can enter the workspace.
                <span className="block mt-4 font-semibold text-foreground">
                  If your account is still pending after 72 hours, contact
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
                <Clock className="h-5 w-5 text-muted-foreground mt-1" size={20} />
                <div>
              ...
              <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
                <Mail01 className="h-5 w-5 text-muted-foreground mt-1" size={20} />
                <div>
